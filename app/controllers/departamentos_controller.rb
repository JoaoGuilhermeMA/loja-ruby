  ...
  def create
    ...
    respond_to do |format|
      if @departamento.save
        format.html { redirect_to departamentos_url(@departamento), notice: "Departamento criado com sucesso." }
  ...
  def update
    respond_to do |format|
      if @departamento.update(departamento_params)
        format.html { redirect_to departamento_url(@departamento), notice: "Departamento atualizado com sucesso" }
